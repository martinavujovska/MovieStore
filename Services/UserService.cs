    ...
    public class UserService
    {
        ...
        public User RegisterUser()
        {
            ...
            else if (subType.ToLower() == "a")
            {
                ...
                Console.WriteLine("Your account has been successfuly created with an annual subscription.");
            }
        ...
        {
            if (user.Movies.Count == 0) { Console.WriteLine("You have no rented movies at this moment"); }
